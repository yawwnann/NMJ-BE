...
@section('content')
    <div class="max-w-lg mx-auto bg-white p-8 rounded-xl shadow-lg mt-8 border border-blue-900">
        <h2 class="text-2xl font-bold text-blue-900 mb-6">Tambah Service</h2>
        @if ($errors->any())
        ...
        @endif
        <form action="{{ route('admin.service.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            <div>
