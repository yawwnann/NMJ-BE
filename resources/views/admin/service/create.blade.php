...
@section('content')
    <h2 class="text-xl font-bold text-blue-900 mb-6">Tambah Service</h2>
    <form action="{{ route('admin.service.store') }}" method="POST" class="max-w-xl bg-white rounded shadow p-6"
